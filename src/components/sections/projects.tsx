...
const slots: Record<string, ScreenshotSlot[]> = {
  "codepulse-ai": [
    { label: "Engineering Dashboard",      aspect: "wide" },
    { label: "Repository Health Matrix",   aspect: "wide" },
    { label: "AI Repository Assistant",    aspect: "wide" },
  ],
  "zarrin-blogs": [
    ...
    <section id="projects" className="border-b border-border py-24">
      <div className="container">
        <SectionHeading
          ...
          description="Three full-stack applications built end to end — from schema design and CI/CD pipelines to an AI-powered analysis platform."
        />
